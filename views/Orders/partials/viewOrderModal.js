              ...
              <div className="leftcontent">
                            ...
                            <li>
                              ...
                              <div className="boxwrapper">
                                <ul>
                                  <li>
                                    <label>Date</label>
                                    <div className="detail">{orderData.type === "Removal" ? getDate(orderData.pickupdate) :getDate(orderData.deliverydate)}</div>
                                  </li>
                                  <li>
                                    <label>Delivery Day</label>
                                    <div className="detail">{orderData.type === "Removal" ? _.get(orderData, 'pickupday', '') !== '' ? _.get(orderData, 'pickupday', '') : getDayDate(orderData.pickupdate) : _.get(orderData, 'deliveryday', '') !== '' ? _.get(orderData, 'deliveryday', '') : deliveryday}</div>
                                  </li>
                                </ul>
                              </div>
                            </li>
                              ...
                              <div className="boxwrapper">
                                ...
                                this.getContainerSize(_.get(orderData, 'container', ''))!== 'Live Load' ?
                                  <ul>
                                    <li>
                                      <label>Purchase Order Number</label>
                                      <div className="detail">{_.get(orderData, 'purchaseordernumber', 'N/A')}</div>
                                    </li>
                                    {_.get(orderData, 'pricingtype', '') !== '' ?
                                    <li>
                                      <label>Pricing Type</label>
                                ...
                                <ul>
                                  ...
                                  <li>
                                    <label>Estimated Taxes</label>
                                    <div className="detail">{this.state.taxes !== "" &&this.state.taxes && this.state.taxes.toFixed(2) ? `$${formatNumber(this.state.taxes.toFixed(2))}` : "" }</div>
                                  </li>
                                  {this.state.discount && this.state.discount !== '' ?
                                  <li>
                                    <label>Discount</label>
                ...
                { this.getStatus(orderData.status, orderData) === "Complete" ?
                  ...
                  { this.getStatus(orderData.status, orderData) !== "Removed" ? <h4>Actions</h4> : "" }
                    ...
                    { this.getStatus(orderData.status, orderData) !== "Removed" && this.getStatus(orderData.status, orderData) !== "Pending Delivery" && this.getStatus(orderData.status, orderData) !== "In Use" && this.getStatus(orderData.status, orderData) !== "Pending Removal" ?
                    ...
                    { (this.getStatus(orderData.status, orderData) === "Pending Delivery" && _.get(orderData, 'inporgress', false) !== true) || this.getStatus(orderData.status, orderData) === "Pending Action" ?
                     <button className="btn btn-dark w-180 w-half font-600 font-16" onClick={this.openCancel.bind(this, orderData.id)}><span> <img src={deleteorderIcon} /> </span>Cancel Order </button>
                     : ''}
                  </div>
                  }
              </div>
