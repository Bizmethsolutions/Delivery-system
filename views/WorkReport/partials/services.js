    ...
    let columns = [
      {
        ...
        key: 'deliverydate',
        render: deliverydate => (moment(deliverydate).isValid() ? moment(deliverydate).format("MM/DD/YYYY") : ""),
      },
      {
      ...
      {
        title: <span onClick={() => { this.sortby('addminis') }} className="custom-table-th-title-sm for-cursor">Add minis {this.getSortArrow('addminis')}</span>,
        width: 120,
        dataIndex: 'addminis',
        key: 'addminis',
        render: addminis => addminis && addminis !== '' && addminis !== undefined ? addminis : 'N/A'
      },
      {
        title: <span onClick={() => { this.sortby('removeminis') }} className="custom-table-th-title-sm for-cursor">Remove Minis {this.getSortArrow('removeminis')}</span>,
        width: 120,
        dataIndex: 'removeminis',
        key: 'removeminis',
        render: removeminis => removeminis && removeminis !== '' && removeminis !== undefined ? removeminis : 'N/A'
      },
      {
      ...
      {
        title: <span onClick={() => { this.sortby('permit') }} className="custom-table-th-title-sm for-cursor">Permit {this.getSortArrow('permit')}</span>,
        width: 200,
        dataIndex: 'permit',
        key: 'permit',
        render: permit => permit === true ? 'Yes' : 'No'
      },
      {
        title: <span onClick={() => { this.sortby('haulercompanyname') }} className="custom-table-th-title-sm for-cursor">Hauler {this.getSortArrow('haulercompanyname')}</span>,
        width: 200,
        dataIndex: 'haular.company_name',
        key: 'haular.company_name',
        render: company_name => company_name && company_name !== '' && company_name !== undefined ? company_name : 'N/A'
      },
      {
